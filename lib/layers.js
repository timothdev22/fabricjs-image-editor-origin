...
(function () {
  ...
  function initializeLayers() {
    ...
    function createLayerItem(fabricObject) {
      ...
      else if (fabricObject.type === 'ellipse') icon = '⚪';
      ...
      layer.innerHTML = `
        ...
        <div class="layer-controls">
          <button class="layer-lock" style="opacity: ${fabricObject.locked ? '1' : '0.5'}; ">🔒</button>
          <button class="layer-visibility" style="opacity: ${fabricObject.visible ? '1' : '0.5'}; ">👁️</button>
