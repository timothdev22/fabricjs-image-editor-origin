  ...
  var canvas = function () {
    try {
      ...
      fabricCanvas.on('object:rotating', (e) => {
        if (e.e.shiftKey) {
          e.selected.snapAngle = 15;
        } else {
          e.selected.snapAngle = false;
        }
      })
