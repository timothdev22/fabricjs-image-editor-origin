    ...
    try {
      ...
      fabric.Object.prototype.toObject = (function (toObject) {
        return function () {
            return fabric.util.object.extend(toObject.call(this), {
                animation: this.animation || null // Inclui a propriedade personalizada "animation"
            });
          };
      ...
      fabric.Object.prototype.initialize = (function (initialize) {
          return function (options) {
              // Garante que a inicialização funcione mesmo com propriedades personalizadas
              initialize.call(this, options);
      
              // Recupera a propriedade "animation" (se existir)
